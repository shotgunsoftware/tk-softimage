...
#define SBK_QTCORE_QLIST_QABSTRACTTRANSITIONPTR_IDX                  24 // QList<QAbstractTransition * >
#define SBK_QTCORE_QSET_QABSTRACTSTATEPTR_IDX                        25 // QSet<QAbstractState * >
...
#define SBK_QTCORE_QPAIR_QREAL_QVARIANT_IDX                          31 // QPair<qreal, QVariant >
#define SBK_QTCORE_QVECTOR_QPAIR_QREAL_QVARIANT_IDX                  32 // QVector<QPair<qreal, QVariant > >
